...
int CheckTopos(int frompos, int topos){
  switch(frompos){
    case(1): if (topos == 8 || topos == 12){
        return true;
      } else {
        return false;
      }
    case(2): if (topos == 9 || topos == 11 || topos == 13 ){
        return true;
      } else {
        return false;
      }
    case(3): if (topos == 6 || topos == 12 || topos == 14 || topos == 10){
        return true;
      } else {
        return false;
      }
    case(4): if (topos == 7 || topos == 15 || topos == 13){
        return true;
      } else {
        return false;
      }
    case(5): if (topos == 8 || topos == 14){
        return true;
      } else {
        return false;
      }
    case(6): if (topos == 3 || topos == 13 || topos == 17){
        return true;
      } else {
        return false;
      }
    case(7): if (topos == 4 || topos == 14 || topos == 18 || topos == 16){
        return true;
      } else {
        return false;
      }
    case(8): if (topos == 5 || topos == 15 || topos == 1 || topos == 11 || topos == 17 || topos == 19){
        return true;
      } else {
        return false;
      }
    case(9): if (topos == 2 || topos == 12 || topos == 18 || topos == 20){
        return true;
      } else {
        return false;
      }
    case(10): if (topos == 3 || topos == 13 || topos == 19){
        return true;
      } else {
        return false;
      }
    case(11): if (topos == 2 || topos == 22 || topos == 8 || topos == 18){
        return true;
      } else {
        return false;
      }
    case(12): if (topos == 9 || topos == 19 || topos == 21 || topos == 23 || topos == 3 || topos == 1){
        return true;
      } else {
        return false;
      }
    case(13): if (topos == 2 || topos == 4 || topos == 6 || topos == 10 || topos == 16 || topos == 20 || topos == 22 || topos == 24){
        return true;
      } else {
        return false;
      }
    case(14): if (topos == 3 || topos == 5 || topos == 7 || topos == 17 || topos == 23 || topos == 25){
        return true;
      } else {
        return false;
      }
    case(15): if (topos == 8 || topos == 24 || topos == 4 || topos == 18 ){
        return true;
      } else {
        return false;
      }
    case(16): if (topos == 7 || topos == 13 || topos == 23){
        return true;
      } else {
        return false;
      }
    case(17): if (topos == 8 || topos ==6 || topos == 14 || topos == 24){
        return true;
      } else {
        return false;
      }
    case(18): if (topos == 11 || topos == 15 || topos == 21 || topos == 25 || topos == 7 || topos == 9 ){
        return true;
      } else {
        return false;
      }
    case(19): if (topos == 8 || topos == 10 || topos == 12 || topos == 22){
        return true;
      } else {
        return false;
      }
    case(20): if (topos == 13 || topos == 23 || topos == 9){
        return true;
      } else {
        return false;
      }
    case(21): if (topos == 18 || topos == 12){
        return true;
      } else {
        return false;
      }
    case(22): if (topos == 11 || topos == 13 || topos == 19){
        return true;
      } else {
        return false;
      }
    case(23): if (topos == 16 || topos == 20 || topos == 12 || topos == 14){
        return true;
      } else {
        return false;
      }
    case(24): if (topos == 17 || topos == 13 || topos == 15){
        return true;
      } else {
        return false;
      }
    case(25): if (topos == 18 || topos == 14){
        return true;
      } else {
        return false;
      }
...
int checkKnight(int position){
  switch(position){
    case(1): if(p1 == BlackKnight || p1 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(2): if(p2 == BlackKnight || p2 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(3): if(p3 == BlackKnight || p3 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(4): if(p4 == BlackKnight || p4 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(5): if(p5 == BlackKnight || p5 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(6): if(p6 == BlackKnight || p6 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(7):if(p7 == BlackKnight || p7 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(8): if(p8 == BlackKnight || p8 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(9): if(p9 == BlackKnight || p9 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(10): if(p10 == BlackKnight || p10 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(11): if(p11 == BlackKnight || p11 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(12): if(p12 == BlackKnight || p12 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(13): if(p13 == BlackKnight || p13 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(14): if(p14 == BlackKnight || p14 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(15): if(p15 == BlackKnight || p15 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(16): if(p16 == BlackKnight || p16 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(17): if(p17 == BlackKnight || p17 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(18): if(p18 == BlackKnight || p18 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(19): if(p19 == BlackKnight || p19 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(20): if(p20 == BlackKnight || p20 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(21): if(p21 == BlackKnight || p21 == WhiteKnight){
        return true;
      } else {
        return false;
      } 
    case(22): if(p22 == BlackKnight || p22 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(23): if(p23 == BlackKnight || p23 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(24): if(p24 == BlackKnight || p24 == WhiteKnight){
        return true;
      } else {
        return false;
      }
    case(25): if(p25 == BlackKnight || p25 == WhiteKnight){
        return true;
      } else {
        return false;
      }
...
string intToString(int position){
  switch(position){
    case(1): return p1;
    case(2): return p2;
    case(3): return p3;
...
void ChangePosition(int from, int to){
  string temp;
  switch(from){
    case(1): temp = p1; p1 = intToString(to); break;
    case(2): temp = p2; p2 = intToString(to); break;
    case(3): temp = p3; p3 = intToString(to); break;
    case(4): temp = p4; p4 = intToString(to); break;
    case(5): temp = p5; p5 = intToString(to); break;
    case(6): temp = p6; p6 = intToString(to); break;
    case(7): temp = p7; p7 = intToString(to); break;
    case(8): temp = p8; p8 = intToString(to); break;
    case(9): temp = p9; p9 = intToString(to); break;
    case(10): temp = p10; p10 = intToString(to); break;
    case(11): temp = p11; p11 = intToString(to); break;
    case(12): temp = p12; p12 = intToString(to); break;
    case(13): temp = p13; p13 = intToString(to); break;
    case(14): temp = p14; p14 = intToString(to); break;
    case(15): temp = p15; p15 = intToString(to); break;
    case(16): temp = p16; p16 = intToString(to); break;
    case(17): temp = p17; p17 = intToString(to); break;
    case(18): temp = p18; p18 = intToString(to); break;
    case(19): temp = p19; p19 = intToString(to); break;
    case(20): temp = p20; p20 = intToString(to); break;
    case(21): temp = p21; p21 = intToString(to); break;
    case(22): temp = p22; p22 = intToString(to); break;
    case(23): temp = p23; p23 = intToString(to); break;
    case(24): temp = p24; p24 = intToString(to); break;
    case(25): temp = p25; p25 = intToString(to); break;
  }
  switch(to){
    case(1): p1 = temp; break;
    case(2): p2 = temp; break;
    case(3): p3 = temp; break;
    case(4): p4 = temp; break;
    case(5): p5 = temp; break;
    case(6): p6 = temp; break;
    case(7): p7 = temp; break;
    case(8): p8 = temp; break;
    case(9): p9 = temp; break;
    case(10): p10 = temp; break;
    case(11): p11 = temp; break;
    case(12): p12 = temp; break;
    case(13): p13 = temp; break;
    case(14): p14 = temp; break;
    case(15): p15 = temp; break;
    case(16): p16 = temp; break;
    case(17): p17 = temp; break;
    case(18): p18 = temp; break;
    case(19): p19 = temp; break;
    case(20): p20 = temp; break;
    case(21): p21 = temp; break;
    case(22): p22 = temp; break;
    case(23): p23 = temp; break;
    case(24): p24 = temp; break;
    case(25): p25 = temp; break;
  }
  displayBoard();
}
// ----------------------------------------------------------------------
